...
export const post: Post = {
    ...
    content: (
      <div className="prose-content">
        ...
        <p>
          Even the good version is a cap. The 2025 SAG-AFTRA Commercials Contract was a real win: 12.5% in compounding increases over three years, a $218 million package, ratified 96.9% to 3.1%. It also codifies a 24-month Maximum Period of Use and prices a digital replica at one and a half times the scale session fee plus use fees. Off-camera scale sits at $588.90 for a TV session and $379.60 for solo audio commercials work. The ceiling moved up without the structure underneath it changing, and that structure still pays for a period of time rather than for how much the work actually gets used.
        </p>
